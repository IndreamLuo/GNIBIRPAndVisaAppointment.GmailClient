...
namespace GNIBIRPAndVisaAppointment.GmailClient.Application
{
    public class OAuthHelper
    {
        ...
        readonly string ClientId = "348048223417-sbdbm1ckd0ans1esc1franojhn5vkiit.apps.googleusercontent.com";
        readonly string ClientSecret = "kiC-nHRHXzaSMcr5WUzMl-xC";
